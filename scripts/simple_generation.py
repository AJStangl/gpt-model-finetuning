...
if __name__ == '__main__':
	...
	sample_outputs = model.generate(inputs=generated.input_ids.cuda(),
									attention_mask=generated['attention_mask'].cuda(), do_sample=True, top_k=40,
									max_length=1024, top_p=0.8, temperature=0.8, num_return_sequences=1,
									repetition_penalty=1.08, stop_token='<|endoftext|>')
